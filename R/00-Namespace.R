...
#' @importFrom leaflegend addLegendNumeric addLegendSize makeSymbolsSize
...
#'  clearMarkerClusters clearGroup clearPopups colorFactor colorNumeric fitBounds hideGroup icons
