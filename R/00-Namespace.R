...
#' @importFrom leaflet addAwesomeMarkers addCircles addControl addLegend addMarkers addPopups
#' addProviderTiles addRectangles addScaleBar addTiles awesomeIconList awesomeIcons
#' clearControls clearPopups clearShapes colorFactor fitBounds leaflet leafletProxy leafletOutput
#' makeAwesomeIcon markerClusterOptions popupOptions removeScaleBar renderLeaflet
#' setMaxBounds setView scaleBarOptions
#' @importFrom magrittr "%>%"
